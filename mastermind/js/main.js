...
const valid = () => {
    ...
    div.innerHTML = "Tour numéro " + tour + " : " +
    '<br />' + '<br />' +
    anwser1 + " - " + anwser2 + " - " + anwser3 + " - " + anwser4 + 
        '<br />' +
        reponse1 + " - " + reponse2 + " - " + reponse3 + " - " + reponse4 + " " + partigagne + 
        '<br />' + '<br />';
